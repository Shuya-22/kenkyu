...
if __name__ == '__main__':
    ...
    r = 0
    l = 0
    random1 = random.sample(range(1, 125), 124)
    ...
    r = 0
    l = 0
    random = random.sample(range(1, 41), 40)
    ...
    #output_func = ScalingShift([10, 10], [0, 0])
...
# ファイル名に日付を組み込んで保存する
    ...
    file_name = folder_name + "/" + bui + formatted_date + "_" + lebel + ".pdf"
