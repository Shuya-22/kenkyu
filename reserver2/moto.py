...
if __name__ == '__main__':
    ...
    # CSVファイルのパスを指定
    Path1 = 'M1/openposewin/out_csv/1201/1201r_' + kakudo + ".csv"
    Path2 = 'M1/openposewin/out_csv/1201/1201l_' + kakudo + ".csv"
    Path3 = 'M1/openposewin/out_csv/1208/1208r_' + kakudo + ".csv"
    Path4 = 'M1/openposewin/out_csv/1208/1208l_' + kakudo + ".csv"
    Path5 = 'M1/openposewin/out_csv/1211/1211r_' + kakudo + ".csv"
    Path6 = 'M1/openposewin/out_csv/1211/1211l_' + kakudo + ".csv"
...
# ファイル名に日付を組み込んで保存する
    ...
    folder_name = "M1/sozai/reserver/" + bui 
    if fb == "y":
        file_name = folder_name + "/" + bui + formatted_date + "_yfb" + ".pdf"
    if fb == "n":
        file_name = folder_name + "/" + bui + formatted_date + "_nfb" + ".pdf"
